                    ...
                    <div class="card">
                        <div class="card-header py-2">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('agama.create') }}" class="btn btn-sm btn-success ml-auto py-1">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-agama" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Agama</th>
