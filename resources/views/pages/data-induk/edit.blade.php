        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('data-induk.update', $data->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_panggilan"
                                                name="nama_panggilan" value="{{ $data_siswa->nama_panggilan }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nisn" name="nisn"
                                                value="{{ $data->nisn }}" placeholder="NISN">
                                            @error('nisn')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir"
                                                value="{{ $data_siswa->tgl_lahir }}" placeholder="Tanggal Lahir">
                                            @error('tgl_lahir')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="agama" name="agama"
                                                value="{{ $data_siswa->agama }}" placeholder="Agama">
                                            @error('agama')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kewarganegaraan"
                                                name="kewarganegaraan" value="{{ $data_siswa->kewarganegaraan }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sdr_kandung"
                                                name="sdr_kandung" value="{{ $data_siswa->sdr_kandung }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sdr_tiri" name="sdr_tiri"
                                                value="{{ $data_siswa->sdr_tiri }}" placeholder="Jml Saudara Tiri">
                                            @error('sdr_tiri')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sdr_angkat" name="sdr_angkat"
                                                value="{{ $data_siswa->sdr_angkat }}" placeholder="Jml Saudara Angkat">
                                            @error('sdr_angkat')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="status_anak"
                                                name="status_anak" value="{{ $data_siswa->status_anak }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="bahasa" name="bahasa"
                                                value="{{ $data_siswa->bahasa }}" placeholder="Bahasa">
                                            @error('bahasa')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                ...
                                <div class="row">
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_telepon" name="no_telepon"
                                                value="{{ $tempat_tinggal->no_telepon }}" placeholder="No Telepon">
                                            @error('no_telepon')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="status_tinggal"
                                                name="status_tinggal" value="{{ $tempat_tinggal->status_tinggal }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="jarak_tinggal"
                                                name="jarak_tinggal" value="{{ $tempat_tinggal->jarak_tinggal }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat" class="form-control" id="" cols="30" rows="3">{{ $tempat_tinggal->alamat }}</textarea>
                                            @error('alamat')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="gol_darah" name="gol_darah"
                                                value="{{ $ket_sehat->gol_darah }}" placeholder="Gol Darah">
                                            @error('gol_darah')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="history_sakit"
                                                name="history_sakit" value="{{ $ket_sehat->history_sakit }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kelainan" name="kelainan"
                                                value="{{ $ket_sehat->kelainan }}" placeholder="Kelainan">
                                            @error('kelainan')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tinggi" name="tinggi"
                                                value="{{ $ket_sehat->tinggi }}" placeholder="Tinggi Badan">
                                            @error('tinggi')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="berat" name="berat"
                                                value="{{ $ket_sehat->berat }}" placeholder="Berat Badan">
                                            @error('berat')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tamatan" name="tamatan"
                                                value="{{ $ket_pendidikan->pendidikan_sebelumnya->tamatan }}"
                                                placeholder="Tamatan">
                                            @error('tamatan')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tgl_nmr_ijasah"
                                                name="tgl_nmr_ijasah"
                                                value="{{ $ket_pendidikan->pendidikan_sebelumnya->tgl_nmr_ijasah }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tgl_nmr_shun"
                                                name="tgl_nmr_shun"
                                                value="{{ $ket_pendidikan->pendidikan_sebelumnya->tgl_nmr_shun }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="lama_belajar"
                                                name="lama_belajar"
                                                value="{{ $ket_pendidikan->pendidikan_sebelumnya->lama_belajar }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dari_sekolah"
                                                name="dari_sekolah" value="{{ $ket_pendidikan->pindahan->dari_sekolah }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="alasan" name="alasan"
                                                value="{{ $ket_pendidikan->pindahan->alasan }}" placeholder="Alasan">
                                            @error('alasan')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dikelas" name="dikelas"
                                                value="{{ $ket_pendidikan->diterima->di_kelas }}" placeholder="Di Kelas">
                                            @error('dikelas')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kelompok" name="kelompok"
                                                value="{{ $ket_pendidikan->diterima->kelompok }}" placeholder="Kelompok">
                                            @error('kelompok')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tanggal_diterima"
                                                ...
                                                value="{{ $ket_pendidikan->diterima->tanggal_diterima }}"
                                ...
                                <div class="row">
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_nama" name="a_nama"
                                                value="{{ $ayah_kandung->nama }}" placeholder="Nama">
                                            @error('a_nama')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_tempat_lahir"
                                                name="a_tempat_lahir" value="{{ $ayah_kandung->tempat_lahir }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="a_tgl_lahir"
                                                name="a_tgl_lahir" value="{{ $ayah_kandung->tgl_lahir }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_agama" name="a_agama"
                                                value="{{ $ayah_kandung->agama }}" placeholder="Agama">
                                            @error('a_agama')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_kewarganegaraan"
                                                name="a_kewarganegaraan" value="{{ $ayah_kandung->kewarganegaraan }}"
                                                placeholder="Kewarganegaraan">
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_pendidikan"
                                                name="a_pendidikan" value="{{ $ayah_kandung->pendidikan }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_pekerjaan"
                                                name="a_pekerjaan" value="{{ $ayah_kandung->pekerjaan }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_pengeluaran"
                                                name="a_pengeluaran" value="{{ $ayah_kandung->pengeluaran }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            <label for="agama">Alamat</label>
                                            <textarea name="a_alamat" class="form-control" id="" cols="30" rows="3">{{ $ayah_kandung->alamat }}</textarea>
                                            @error('a_alamat')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_no_telepon"
                                                name="a_no_telepon" value="{{ $ayah_kandung->no_telepon }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="a_status_hidup"
                                                name="a_status_hidup" value="{{ $ayah_kandung->status_hidup }}"
                                                placeholder="Tanggal Di Terima">
                                ...
                                <div class="row">
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_nama" name="i_nama"
                                                value="{{ $ibu_kandung->nama }}" placeholder="Nama">
                                            @error('i_nama')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_tempat_lahir"
                                                name="i_tempat_lahir" value="{{ $ibu_kandung->tempat_lahir }}"
                                                placeholder="Tempat Lahir">
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="i_tgl_lahir"
                                                name="i_tgl_lahir" value="{{ $ibu_kandung->tgl_lahir }}"
                                                placeholder="Tanggal Lahir">
                                            @error('i_tgl_lahir')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_agama" name="i_agama"
                                                value="{{ $ibu_kandung->agama }}" placeholder="Agama">
                                            @error('i_agama')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_kewarganegaraan"
                                                name="i_kewarganegaraan" value="{{ $ibu_kandung->kewarganegaraan }}"
                                                placeholder="Kewarganegaraan">
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_pendidikan"
                                                name="i_pendidikan" value="{{ $ibu_kandung->pendidikan }}"
                                                placeholder="Pendidikan">
                                            @error('i_pendidikan')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_pekerjaan"
                                                name="i_pekerjaan" value="{{ $ibu_kandung->pekerjaan }}"
                                                placeholder="Pekerjaan">
                                            @error('i_pekerjaan')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_pengeluaran"
                                                name="i_pengeluaran" value="{{ $ibu_kandung->pengeluaran }}"
                                                placeholder="Pengeluaran">
                                            @error('i_pengeluaran')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <textarea name="i_alamat" class="form-control" id="" cols="30" rows="3">{{ $ibu_kandung->alamat }}</textarea>
                                            @error('i_alamat')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_no_telepon"
                                                name="i_no_telepon" value="{{ $ibu_kandung->no_telepon }}"
                                                placeholder="No Telepon">
                                            @error('i_no_telepon')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="i_status_hidup"
                                                name="i_status_hidup" value="{{ $ibu_kandung->status_hidup }}"
                                                placeholder="Tanggal Di Terima">
                                ...
                                <div class="row">
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_nama" name="w_nama"
                                                value="{{ $wali->nama }}" placeholder="Nama">
                                            @error('w_nama')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_tempat_lahir"
                                                name="w_tempat_lahir" value="{{ $wali->tempat_lahir }}"
                                                placeholder="Tempat Lahir">
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="w_tgl_lahir"
                                                name="w_tgl_lahir" value="{{ $wali->tgl_lahir }}"
                                                placeholder="Tanggal Lahir">
                                            @error('w_tgl_lahir')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_agama" name="w_agama"
                                                value="{{ $wali->agama }}" placeholder="Agama">
                                            @error('w_agama')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_kewarganegaraan"
                                                name="w_kewarganegaraan" value="{{ $wali->kewarganegaraan }}"
                                                placeholder="Kewarganegaraan">
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_pendidikan"
                                                name="w_pendidikan" value="{{ $wali->pendidikan }}"
                                                placeholder="Pendidikan">
                                            @error('w_pendidikan')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_pekerjaan"
                                                name="w_pekerjaan" value="{{ $wali->pekerjaan }}"
                                                placeholder="Pekerjaan">
                                            @error('w_pekerjaan')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_pengeluaran"
                                                name="w_pengeluaran" value="{{ $wali->pengeluaran }}"
                                                placeholder="Pengeluaran">
                                            @error('w_pengeluaran')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            <label for="i_alamat">Alamat</label>
                                            <textarea name="w_alamat" class="form-control" id="" cols="30" rows="3">{{ $wali->alamat }}</textarea>
                                            @error('w_alamat')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="w_no_telepon"
                                                name="w_no_telepon" value="{{ $wali->no_telepon }}"
                                                placeholder="No Telepon">
                                            @error('w_no_telepon')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kesenian" name="kesenian"
                                                value="{{ $kegemaran->kesenian }}" placeholder="Kesenian">
                                            @error('kesenian')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="olahraga" name="olahraga"
                                                value="{{ $kegemaran->olahraga }}" placeholder="Olahraga">
                                            @error('olahraga')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="organisasi" name="organisasi"
                                                value="{{ $kegemaran->organisasi }}" placeholder="Organisasi">
                                            @error('organisasi')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="lain_lain" name="lain_lain"
                                                value="{{ $kegemaran->lain_lain }}" placeholder="Lain-lain">
                                            @error('lain_lain')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tgl_meninggalkan_sekolah"
                                                ...
                                                value="{{ $ket_pengembangan->meninggalkan_sekolah->tgl_meninggalkan_sekolah }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="alasan_meninggalkan_sekolah"
                                                ...
                                                value="{{ $ket_pengembangan->meninggalkan_sekolah->alasan_meninggalkan_sekolah }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tanggal_lulus"
                                                name="tanggal_lulus"
                                                value="{{ $ket_pengembangan->akhir_pendidikan->tanggal_lulus }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nomor_ijazah"
                                                name="nomor_ijazah"
                                                value="{{ $ket_pengembangan->akhir_pendidikan->nomor_ijazah }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nomor_shun" name="nomor_shun"
                                                value="{{ $ket_pengembangan->akhir_pendidikan->nomor_shun }}"
                                                placeholder="Nomor SHUN">
                                            @error('nomor_shun')
                                                <small class="text-danger" role="alert">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="melanjutkan_ke"
                                                name="melanjutkan_ke"
                                                value="{{ $ket_selesai_pendidikan->melanjutkan_ke }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tanggal_mulai_bekerja"
                                                ...
                                                value="{{ $ket_selesai_pendidikan->bekerja->tanggal_mulai_bekerja }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama_perusahaan"
                                                ...
                                                value="{{ $ket_selesai_pendidikan->bekerja->nama_perusahaan }}"
                                    ...
                                    <div class="col-4 mt--2 mb-0">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="penghasilan"
                                                name="penghasilan"
                                                value="{{ $ket_selesai_pendidikan->bekerja->penghasilan }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-sm btn-success" id="save">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
